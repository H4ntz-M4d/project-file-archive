<x-layouts.app>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <!--begin::Tambah Surat-->
            <form id="kt_arsip_form" data-store-url="{{ route('kategori.store') }}" data-kt-redirect="{{ route('kategori.list') }}">
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="col-12 d-md-block col-md-9">
                                ...
                                <div class="form-floating mb-7">
                                    <input type="text" class="form-control" name="id_kategori" required id="floatingInput" value="{{ $nextID }}" disabled/>
                                    <label class="text-muted" for="floatingInput">ID</label>
                                </div>
                                <!--end::Input-->
                                <!--begin::Input-->
                                <div class="form-floating mb-7">
                                    <input type="text" class="form-control" name="nama_kategori" required id="floatingInput" placeholder="Katgeori"/>
                                    <label class="text-muted" for="floatingInput">Nama Kategori</label>
                                </div>
                                <!--end::Input-->
                                <!--begin::Input-->
                                <div class="form-floating mb-7">
                                    <textarea type="text" class="form-control h-100px" name="keterangan" required id="floatingInput" placeholder="Keterangan"></textarea>
