<x-layouts.app>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <!--begin::Tambah Surat-->
            <form id="kt_arsip_form" data-store-url="{{ route('arsip.store') }}" data-kt-redirect="{{ route('arsip.list') }}">
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="col-12 d-md-block col-md-9">
                                ...
                                <div class="form-floating mb-7">
                                    <input type="text" class="form-control" name="nomor_surat" required id="floatingInput" placeholder="Nomor Surat"/>
                                ...
                                <!--begin::Input-->
                                <div class="form-floating mb-7">
                                    <input type="text" class="form-control" name="judul" required id="floatingInput" placeholder="Judul Surat"/>
                                    <label class="text-muted" for="floatingInput">Judul surat</label>
                                </div>
                                <!--end::Input-->
                                <!--begin::Input-->
                                <div class="mb-7">
                                    <input type="text" class="form-control" name="waktu_pengarsipan" required id="kt_daterangepicker_3" placeholder="Tanggal Pengarsipan"/>
                                </div>
                                <!--end::Input-->
                                <!--begin::Input-->
                                <div class="mb-7">
